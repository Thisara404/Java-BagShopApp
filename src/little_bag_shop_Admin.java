...
public class little_bag_shop_Admin extends javax.swing.JFrame {
    ...
    private void addItemsToPanel() {
        Admin_dashPanel.setLayout(new java.awt.GridLayout(0, 1));  // Set layout to handle multiple items
        ...
        for (Item item : items) {
            Admin_dashPanel.add(item);
        }
         Admin_dashPanel.revalidate();
        Admin_dashPanel.repaint();
    }
